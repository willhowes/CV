...
| ------------- |:-------------:| -----:|
| ['meet in the midl'](https://github.com/gennyallcroft/meet-in-the-middle-react-front-end) | Makers Academy Final Group Project | [Back-end](https://github.com/Timdavidcole/meet-in-the-middle-backend-api) - Ruby on Rails, [Front-end](https://github.com/gennyallcroft/meet-in-the-middle-react-front-end) - React |
...
#### Problem Solving
As a property lawyer, I would often come up against a range of technical and logistical problems. I could rely on my logical reasoning skills to find solutions to such challenges.
